...
*  **Smart City Edge-to-Cloud Pipeline:** A full-stack, dockerized infrastructure routing environmental, smart-lighting (Zhaga), and AI-camera data via Node-RED into InfluxDB & Grafana.
*  **AI-Supported Heat Block (SITL):** A Software-in-the-Loop prototype combining a mathematical PID thermal control algorithm with AI-driven cellular anomaly detection.
